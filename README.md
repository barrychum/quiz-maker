...
This is a user-friendly web application that allows you to create short quizzes in a single HTML file.([Click here for demo](https://barry-the-nerd.github.io/lituk)) It's perfect for:   
