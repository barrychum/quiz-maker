...
This is a user-friendly web application that allows you to create short quizzes in a single HTML file.([Click here for demo](https://github.com/barrychum/quiz-maker)) It's perfect for:   
